...
const checkowner=(id:string)=>{
  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-4 bg-white shadow-lg rounded-xl overflow-hidden mt-10  md:max-w-6xl flex flex-col md:flex-row">
      ...
      <div className="md:w-1/2 p-6 flex flex-col justify-between bg-gray-100">
        <div className="space-y-2">
          ...
          <p className="text-lg font-semibold text-gray-800">Price: {vehicle.price} / Per Day</p>
