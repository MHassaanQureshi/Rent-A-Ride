     ...
     {/* form to make booking */}
      {status === "authenticated" && (
        <div className="flex flex-col  items-center mt-10 p-4 md:w-1/2">
          <h1 className="text-2xl font-bold">Submit Your Details</h1>
          <form
          ...
          >
            <input
              ...
              className="w-[80%] border-b-2 bg-transparent"
              required
            />
            <input
              type="email"
              ...
              <span className="flex flex-col items-center">
                ...
                <Calendar
                 ...
                 disabled={(date) =>
                  ...
                  className="rounded-lg border text-black bg-white"
                />
              </span>
              <span className="flex flex-col items-center">
            ...
            <p>You will have to pay 50% of the amount before delivery.</p>
      ...
      {status === "unauthenticated" && (
        <div className="flex flex-row items-center w-full justify-center align-middle mt-10" id="login">
          <button className="bg-gray-700 text-white p-4 rounded">
